    ...
    cart.forEach((item, index) => {
        ...
        itemsDiv.innerHTML += `
            <div>
                ...
                <button onclick="removeFromCart(${index}); event.stopPropagation();" style="background:black; color:red; padding:0px 0px; border:none; border-radius:5px; cursor:pointer; margin-left:8px; font-weight:bold; font-size:13px; white-space:nowrap; line-height:1.5;">Supprimer</button>
            </div>
        `;
